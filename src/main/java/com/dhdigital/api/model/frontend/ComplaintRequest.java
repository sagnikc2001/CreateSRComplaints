...
public class ComplaintRequest {
	...
	public String toString() {
		return "ComplaintRequest [type=" + type + ", area=" + area + ", dupFlg=" + dupFlg + ", attrib1=" + attrib1
				...
				+ ", requestType=" + requestType + ", atmCardNumber=" + atmCardNumber + "]";
	}
	...
	public int hashCode() {
		return Objects.hash(accountId, accountType, amount, area, atmCardNumber, attachment, attrib1, attrib10,
				...
				dupFlg, financialClaimType, heatNumber, merchantName, merchantNumber, mobileNumber, problemType,
				processAmount, processNumber, receivedCallDate, region, requestType, sRDescription, sRMobilePhoneNumber,
				sRService, source, subArea, terminalCount, terminalNumber, type, vendorEmail);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(accountId, other.accountId) && Objects.equals(accountType, other.accountType)
				...
				&& Objects.equals(heatNumber, other.heatNumber) && Objects.equals(merchantName, other.merchantName)
